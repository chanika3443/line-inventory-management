  ...
  if (!isLoggedIn) {
    return (
      <div style={{
        ...
        padding: '20px',
        background: 'linear-gradient(180deg, #6B7FED 0%, #8B6FB8 100%)'
      }}>
        <div style={{
          background: 'white',
          borderRadius: '32px',
          ...
          <div style={{
            width: '110px',
            height: '110px',
            background: 'linear-gradient(135deg, #6B7FED 0%, #8B6FB8 100%)',
            borderRadius: '28px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            margin: '0 auto 32px',
            boxShadow: '0 12px 32px rgba(107, 127, 237, 0.35)'
          }}>
            <Icon name="products" size={56} color="white" />
          </div>
            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 8px 20px rgba(6, 199, 85, 0.35)'
                }}
                onMouseDown={(e) => {
                ...
                onMouseUp={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 8px 20px rgba(6, 199, 85, 0.35)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'scale(1)'
                  e.currentTarget.style.boxShadow = '0 8px 20px rgba(6, 199, 85, 0.35)'
              ...
              >
                ...
                <span style={{ marginLeft: '44px' }}>Login with LINE</span>
              </button>
